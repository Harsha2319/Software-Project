...
<% ArrayList<History> driverList = drivercontroller.viewDriverHistory("ram"); %>
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover mx-auto w-auto" style="font-size:16px;margin:auto; width:50% !important;">
                            ...
                            <% for(int i = 0; i < driverList.size(); i++) { %>
                              <tr>
                                <td><%= driverList.get(i).getRideID() %></td>
                                <td><%= driverList.get(i).getSrc() %></td>
                                <td><%= driverList.get(i).getDest() %></td>
                                <td><%= driverList.get(i).getC_id() %></td>
                                <td><%= driverList.get(i).getD_id() %></td>
                                <td><%= driverList.get(i).getCost() %></td>
                              </tr>
                              <% } %>
                            </tbody>
                          </table>
